...
Map_insurance = pd.DataFrame(table4,columns = ("States", "Years", "Quarter", "Districts","Transaction_type", "Transaction_count","Transaction_amount"))
...
def Aggre_insurance_Y(df, year, context=""):
    ...
    with col1:
        ...
        st.plotly_chart(fig_amount, use_container_width=True, key=f"fig_amount_{year}_{context}")
    with col2:
        ...
        st.plotly_chart(fig_count, use_container_width=True, key=f"fig_count_{year}_{context}")
    col1,col2= st.columns(2)
    with col1:
        ...
        st.plotly_chart(fig_india_1, use_container_width=True, key=f"fig_india_1_{year}_{context}")
    with col2:
        ...
        st.plotly_chart(fig_india_2, use_container_width=True, key=f"fig_india_2_{year}_{context}")
    return aiy


def Aggre_insurance_Y_Q(df, quarter, context=""):
    ...
    with col1:
        ...
        st.plotly_chart(fig_q_amount, use_container_width=True, key=f"fig_q_amount_{quarter}_{context}")
    with col2:
        ...
        st.plotly_chart(fig_q_count, use_container_width=True, key=f"fig_q_count_{quarter}_{context}")
    col1,col2= st.columns(2)
    with col1:
        url= "https://gist.githubusercontent.com/jbrobst/56c13bbbf9d97d187fea01ca62ea5112/raw/e388c4cae20aa53cb5090210a42ebb9b765c0a36/india_states.geojson"
        response= requests.get(url)
        ...
        fig_india_1= px.choropleth(aiyqg, geojson= data1, locations= "States", featureidkey= "properties.ST_NM",
                                 ...
                                 fitbounds= "locations",width =600, height= 600)
        fig_india_1.update_geos(visible =False)
        st.plotly_chart(fig_india_1, use_container_width=True, key=f"fig_india_1_{quarter}_{context}")
    with col2:
        fig_india_2= px.choropleth(aiyqg, geojson= data1, locations= "States", featureidkey= "properties.ST_NM",
                                 ...
                                 fitbounds= "locations",width =600, height= 600)
        fig_india_2.update_geos(visible =False)
        st.plotly_chart(fig_india_2, use_container_width=True, key=f"fig_india_2_{quarter}_{context}")
    return aiyq
...
def Aggre_Transaction_type(df, state):
    ...
    st.plotly_chart(fig_hbar_1, use_container_width=True, key=f"fig_hbar_1_{state}")
    ...
    st.plotly_chart(fig_hbar_2, use_container_width=True, key=f"fig_hbar_2_{state}")
...
def Aggre_user_plot_1(df,year):
    ...
    st.plotly_chart(fig_line_1, use_container_width=True, key=f"fig_line_1_{year}")
...
def Aggre_user_plot_2(df,quarter):
    ...
    st.plotly_chart(fig_pie_1, use_container_width=True, key=f"fig_pie_1_{quarter}")
...
def Aggre_user_plot_3(df,state):
    ...
    st.plotly_chart(fig_scatter_1, use_container_width=True, key=f"fig_scatter_1_{state}")
...
def map_insure_plot_1(df,state):
    ...
    st.plotly_chart(fig_map_bar_1, use_container_width=True, key=f"fig_map_bar_1_amount_{state}")
    ...
    st.plotly_chart(fig_map_bar_1, use_container_width=True, key=f"fig_map_bar_1_count_{state}")
...
def map_insure_plot_2(df,state):
    ...
    st.plotly_chart(fig_map_pie_1, use_container_width=True, key=f"fig_map_pie_1_amount_{state}")
    ...
    st.plotly_chart(fig_map_pie_1, use_container_width=True, key=f"fig_map_pie_1_count_{state}")
...
def map_user_plot_1(df, year):
    ...
    st.plotly_chart(fig_map_user_plot_1, use_container_width=True, key=f"fig_map_user_plot_1_{year}")
...
def map_user_plot_2(df, quarter):
    ...
    st.plotly_chart(fig_map_user_plot_1, use_container_width=True, key=f"fig_map_user_plot_1_{quarter}")
...
def map_user_plot_3(df, state):
    ...
    st.plotly_chart(fig_map_user_plot_1, use_container_width=True, key=f"fig_map_user_plot_1_{state}")

    with col2:
        fig_map_user_plot_2= px.bar(muyqsg, x= "AppOpens", y= "Districts",orientation="h",
                                    title= f"{state.upper()} APPOPENS",height=800,
                                    color_discrete_sequence= px.colors.sequential.Rainbow)
    st.plotly_chart(fig_map_user_plot_2, use_container_width=True, key=f"fig_map_user_plot_2_{state}")
...
def top_user_plot_1(df,year):
    ...
    st.plotly_chart(fig_top_plot_1, use_container_width=True, key=f"fig_top_plot_1_{year}")
...
def top_user_plot_2(df,state):
    ...
    st.plotly_chart(fig_top_plot_1, use_container_width=True, key=f"fig_top_plot_1_{state}")
...
def ques1():
    ...
    return st.plotly_chart(fig_brands, use_container_width=True, key="fig_brands")
...
def ques2():
    ...
    return st.plotly_chart(fig_lts, use_container_width=True, key="fig_lts_lowest")
...
def ques3():
    ...
    return st.plotly_chart(fig_htd, use_container_width=True, key="fig_htd_highest")
...
def ques4():
    ...
    return st.plotly_chart(fig_htd, use_container_width=True, key="fig_htd_lowest")
...
def ques5():
    ...
    return st.plotly_chart(fig_sa, use_container_width=True, key="fig_sa_top")
...
def ques6():
    ...
    return st.plotly_chart(fig_sa, use_container_width=True, key="fig_sa_least")
...
def ques7():
    ...
    return st.plotly_chart(fig_stc, use_container_width=True, key="fig_stc_lowest")
...
def ques8():
    ...
    return st.plotly_chart(fig_stc, use_container_width=True, key="fig_stc_highest")
...
def ques9():
    ...
    fig_lts= px.bar(ht2, x= "States", y= "Transaction_amount",title= "HIGHEST TRANSACTION AMOUNT and STATES",
                    color_discrete_sequence= px.colors.sequential.Oranges_r)
    return st.plotly_chart(fig_lts, use_container_width=True, key="fig_lts_highest")
...
def ques10():
    ...
    fig_dt= px.bar(dt2, x= "Districts", y= "Transaction_amount", title= "DISTRICTS WITH LOWEST TRANSACTION AMOUNT",
                color_discrete_sequence= px.colors.sequential.Mint_r)
    return st.plotly_chart(fig_dt, use_container_width=True, key="fig_dt_lowest")
...
if select == "Home":
    ...
    with col2:
        st.video("https://www.youtube.com/watch?v=palTaE1VOmU")

    col3,col4= st.columns(2)
    
    with col3:
        st.video("https://www.youtube.com/watch?v=pvT0uaLFeW0")
...
if select == "Data Exploration":
    ...
    with tab1:
        ...
        if method == "Insurance Analysis":
            if Aggre_insurance.empty:
                ...
                df_agg_insur_Y = Aggre_insurance_Y(Aggre_insurance, years, context="agg_tab")
                col1, col2 = st.columns(2)
                with col1:
                    quarters = st.slider("**Select the Quarter**", int(df_agg_insur_Y["Quarter"].min()), int(df_agg_insur_Y["Quarter"].max()), int(df_agg_insur_Y["Quarter"].min()))
                Aggre_insurance_Y_Q(df_agg_insur_Y, quarters, context="agg_tab")

        elif method == "Transaction Analysis":
            if Aggre_transaction.empty:
                st.warning("No transaction data available.")
            else:
                col1, col2 = st.columns(2)
                with col1:
                    years_at = st.slider("**Select the Year**", int(Aggre_transaction["Years"].min()), int(Aggre_transaction["Years"].max()), int(Aggre_transaction["Years"].min()))
                df_agg_tran_Y = Aggre_insurance_Y(Aggre_transaction, years_at, context="tran_tab")
                col1, col2 = st.columns(2)
                with col1:
                    quarters_at = st.slider("**Select the Quarter**", int(df_agg_tran_Y["Quarter"].min()), int(df_agg_tran_Y["Quarter"].max()), int(df_agg_tran_Y["Quarter"].min()))
                df_agg_tran_Y_Q = Aggre_insurance_Y_Q(df_agg_tran_Y, quarters_at, context="tran_tab")
    ...
    with tab2:
        ...
        if method_map == "Map Insurance Analysis":
            ...
            df_map_insur_Y= Aggre_insurance_Y(Map_insurance, years_m1, context="map_tab")
            col1,col2= st.columns(2)
            with col1:
            ...
            df_map_insur_Y_Q= Aggre_insurance_Y_Q(df_map_insur_Y, quarters_m1, context="map_tab")
            ...
            df_map_tran_Y= Aggre_insurance_Y(Map_transaction, years_m2, context="map_tran_tab")
            col1,col2= st.columns(2)
            with col1:
            ...
            df_map_tran_Y_Q= Aggre_insurance_Y_Q(df_map_tran_Y, quarters_m2, context="map_tran_tab")
    ...
    with tab3:
        ...
        if method_top == "Top Insurance Analysis":
            ...
            df_top_insur_Y= Aggre_insurance_Y(Top_insurance, years_t1, context="top_tab")
            ...
            df_top_insur_Y_Q= Aggre_insurance_Y_Q(df_top_insur_Y, quarters_t1, context="top_tab")
            ...
            df_top_tran_Y= Aggre_insurance_Y(Top_transaction, years_t2, context="top_tran_tab")
            ...
            df_top_tran_Y_Q= Aggre_insurance_Y_Q(df_top_tran_Y, quarters_t2, context="top_tran_tab")
